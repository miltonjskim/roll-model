...
export const DatasetInfoCard = ({ dataset }: DatasetInfoCardProps) => {
  ...
  return (
    <div className="grid grid-cols-2 gap-4 md:grid-cols-4">
      <div className="bg-[theme(color-blue-03)] hover:bg-[theme(color-blue-04)] flex justify-between rounded-lg p-3 transition-all duration-200 ease-in-out hover:translate-y-[-4px] hover:shadow-lg">
      ...
      <div className="bg-[theme(color-yellow-03)] hover:bg-[theme(color-yellow-04)] flex justify-between rounded-lg p-3 transition-all duration-200 ease-in-out hover:translate-y-[-4px] hover:shadow-lg">
        <div className="flex flex-col">
      ...
      <div className="bg-[theme(color-green-03)] hover:bg-[theme(color-green-04)] flex justify-between rounded-lg p-3 transition-all duration-200 ease-in-out hover:translate-y-[-4px] hover:shadow-lg">
        <div className="flex flex-col">
      ...
      <div className="bg-[theme(color-pink-03)] hover:bg-[theme(color-pink-04)] flex justify-between rounded-lg p-3 transition-all duration-200 ease-in-out hover:translate-y-[-4px] hover:shadow-lg">
        <div className="flex flex-col">
